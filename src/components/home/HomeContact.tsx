        ...
        <div className="athoo-navy flex flex-col justify-center px-8 py-24 text-white lg:px-24">
          ...
          <div className="mb-12">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.facebook.com/share/17YFFojFAc/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="flex h-12 w-12 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-white/20">
