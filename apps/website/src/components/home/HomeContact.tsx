            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <div className="space-y-1">
                  <a href="mailto:info@athoo.pk" className="block text-lg font-medium text-[#FF8A00] transition-colors hover:text-orange-400">info@athoo.pk</a>
                  <a href="mailto:support@athoo.pk" className="block text-sm font-medium text-gray-300 transition-colors hover:text-white">support@athoo.pk</a>
                  <a href="mailto:official@athoo.pk" className="block text-sm font-medium text-gray-300 transition-colors hover:text-white">official@athoo.pk</a>
                </div>
              </div>
            </div>
