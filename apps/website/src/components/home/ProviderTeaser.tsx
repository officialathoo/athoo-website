  ...
  return (
    <section className="overflow-hidden bg-white">
      <div className="grid lg:grid-cols-2">
        <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: false, amount: 0.25 }} transition={{ duration: 0.8 }} className="flex flex-col justify-center bg-gradient-to-br from-[#FF8A00] to-orange-600 px-6 py-16 text-white sm:px-8 sm:py-24 lg:px-24">
        ...
        <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: false, amount: 0.25 }} transition={{ duration: 0.8 }} className="flex flex-col justify-center gap-4 bg-gray-50 px-5 py-16 sm:gap-6 sm:px-8 sm:py-24 lg:px-24">
