...
export default function FaqSection() {
  const faqs = [
    ...
    { q: "How do I contact Athoo?", a: "You can email official@athoo.pk or WhatsApp/call +92 339 0051068. The same contact details are available in the footer and contact section of the website." },
    { q: "Can I partner with Athoo?", a: "Yes. Businesses, service professionals and local teams can contact Athoo through the website contact form or by emailing official@athoo.pk." },
